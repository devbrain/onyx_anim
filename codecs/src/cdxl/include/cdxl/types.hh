...
// Bridge lib_cdxl's local type names to onyx_anim's expected/error types.
// Free of musac/onyx_image deps; CDXL is wholly big-endian (Amiga CDTV
// heritage), so byte_reader defaults to BE.
